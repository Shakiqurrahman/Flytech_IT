...
const Courses = () => {
  return (
    <div className="max-width my-10 font-bangla">
      <div className="flex gap-5 items-start relative">
        <div className="w-[calc(100%_-_380px)]">
          <div>
            <Image
              src={thumbnail}
            ...
            <div className="flex items-center bg-dark-gradient rounded-lg p-6 justify-around shadow">
              <div className="text-center">
                <h1 className="text-blue-400 font-medium text-3xl">161</h1>
                <p className="text-lg">Students</p>
              </div>
              <div className="text-center">
                <h1 className="text-blue-400 font-medium text-3xl">150+</h1>
                <p className="text-lg">Hours of Lessons</p>
              </div>
              <div className="text-center">
                <h1 className="text-blue-400 font-medium text-3xl">60</h1>
