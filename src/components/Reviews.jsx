    ...
    return (
        <>
            ...
            <div className="mt-16 relative flex min-h-[500px] w-full flex-col items-center justify-center overflow-hidden rounded-lg md:shadow-xl gap-y-10">
                ...
                <div className="pointer-events-none absolute inset-y-0 left-0 w-1/5 sm:w-1/4  bg-gradient-to-r from-body "></div>
                <div className="pointer-events-none absolute inset-y-0 right-0 w-1/5 sm:w-1/4bg-gradient-to-l from-body "></div>
            </div>
        </>
    );
};
