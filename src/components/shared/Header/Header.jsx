...
const Header = () => {
  ...
  return (
    <header className="py-4 border-b border-gray-700/50 backdrop:blur relative z-10">
      <div className="flex justify-between items-center max-width md:gap-0 gap-3">
        <div>
          <Image src={logo} alt="Flytech It" className="w-32 sm:w-40" />
        </div>
      ...
      <nav
        ...
        } block md:hidden absolute top-full left-0 w-full p-4 bg-black/50 backdrop-blur-[25px] z-[9] duration-500 min-h-screen`}
      >
        <ul className="font-medium text-base *:my-3">
          <li>
            <Link href="/">Home</Link>
          </li>
          <li>
